...
window.CampaignProgress={
  ...
  isUnlocked(eventId){const completed=this.load().completed;if(eventId==="endless-classroom")return true;if(eventId==="cafeteria-containment")return completed.includes("endless-classroom");if(eventId==="library-reality-audit")return completed.includes("cafeteria-containment");if(eventId==="magnum-mirroring-incident")return completed.includes("library-reality-audit");return false;},
