...
global.window=global;global.SEONGA_TEST_INSTANT_PRESENTATION=true;let saved=JSON.stringify({completed:["endless-classroom"]});global.localStorage={getItem(){return saved;},setItem(key,value){saved=value;}};
