...
require("../data/campaign.js");require("../data/characters.js");require("../data/neutral-abilities.js");require("../data/magnum-incident.js");require("../magnum-engine.js");require("../magnum-app.js");
...
const source=fs.readFileSync(path.join(__dirname,"../magnum-app.js"),"utf8"),css=fs.readFileSync(path.join(__dirname,"../styles.css"),"utf8");assert.doesNotMatch(source,/setTimeout\(advancePresentation/);assert.match(source,/data-action="presentation-next">계속/);assert.match(css,/\.accent-magnum\{/);assert.doesNotMatch(css,/:root\s*\{[^}]*--magnum/s);
